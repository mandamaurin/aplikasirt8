                        ...
                        <div class="panel-body">
                            ...
                            <!--<div class="row">
                             <div class="box-tools" style="width: 300px; margin-left: 35px; margin-bottom: 20px;">
                                <form action="pemasukan.php" method="GET">
                ...
                <div class="col-lg-12">
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    <?php
                                        ...
                                        if(isset($_GET['qcari'])){
                                            ...
                                            $sql = "SELECT * FROM tabel_pengeluaran, tabel_warga WHERE tabel_pengeluaran.nik = tabel_warga.nik LIMIT ".$limit_start.",".$limit;                                    
                                        }
                                        ...
                                        while ($row = mysqli_fetch_array($query)){
                                            ...
                                            echo "<td>";
                                            echo "</a> <a class='btn btn-danger' data-toggle='tooltip' data-placement='left' title='Hapus' href='pengeluaran-hapus.php?id=".$row['id_pengeluaran']."' onClick ='return hapus()'><i class='fa fa-trash fa-fw'></i></a> ";
                                            echo "</td>";
                                            echo "</tr>";
                                            echo "</tbody>";
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            ?>
                            <li><a href="pengeluaran.php?page=1">First</a></li>
                            <li><a href="pengeluaran?page=<?php echo $link_prev; ?>">&laquo;</a></li>
                            <?php
                                }
                            ?>
                            ...
                            <?php
                                ...
                                $sql2 = "SELECT COUNT(*) AS jmlh FROM tabel_pengeluaran";
                                ...
                                ?>
                                <li <?php echo $link_active; ?>><a href="pengeluaran.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                            <?php
                                }
                            ?>
                            ...
                            ?>
                            <li><a href="pengeluaran.php?page=<?php echo $link_next; ?>">&raquo;</a></li>
                            <li><a href="pengeluaran.php?page=<?php echo $jumlah_page; ?>">Last</a></li>
                            <?php
                                }
                            ?>
                         </ul>
