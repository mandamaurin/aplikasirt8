...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Lihat Data Warga</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <a href="warga-list.php">Lihat Semua Data Warga RT 08/13</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Lihat Data Warga Berdasarkan KK
                </div>
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        while ($row = mysqli_fetch_array($query)){
                                            ...
                                            echo "<td>";
                                            echo "<a data-toggle='tooltip' data-placement='left' title='Lihat' href='warga-kk.php?id=".$row['no_kk']."'><i class='fa fa-eye fa-fw'></i></a>";
                                            echo "<a data-toggle='tooltip' data-placement='left' title='Hapus' href='kk-hapus.php?id=".$row['no_kk']."' onClick='return hapusKK()'><i class='fa fa-trash fa-fw'></i></a>";
                                            echo "</td>";
                                            echo "</tr>";
                                            echo "</tbody>";
                            ...
                            <!--
                                ...
                                if ($page == 1) { // Jika page adalah pake ke 1, maka disable link PREV
                                    ...
                                    ?>
                                    <li><a href="lihatwarga.php?page=1">First</a></li>
                                    <li><a href="lihatwarga?page=<?php echo $link_prev; ?>">&laquo;</a></li>
                                    <?php
                                }
                                ?>
                                ...
                                for ($i = $start_number; $i <= $end_number; $i++) {
                                    ...
                                    ?>
                                    <li <?php echo $link_active; ?>><a href="lihatwarga.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                    <?php
                                }
                                ?>
                                ...
                                if ($page == $jumlah_page) { // Jika page terakhir
                                    ...
                                    ?>
                                    <li><a href="lihatwarga.php?page=<?php echo $link_next; ?>">&raquo;</a></li>
                                    <li><a href="lihatwarga.php?page=<?php echo $jumlah_page; ?>">Last</a></li>
                                    <?php
                                }
                                ?>
                            </ul>
