<?php 
    $title = "Lihat Buku Berdasarkan Tahun";
    include("layout-header.php");

    $id = $_GET['id'];
    $sql = mysqli_query($koneksi, "SELECT * FROM buku WHERE pengarang = '$id'");
    $pengarang = mysqli_fetch_array($sql);
?>

        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Data Buku Berdasarkan Pengarang : <?php echo $pengarang['pengarang'] ?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    <?php
                                        ...
                                        $sql1 = "SELECT * FROM buku WHERE pengarang = '$id' LIMIT ".$limit_start.",".$limit;
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            ?>
                            <li><a href="bukulist-pengarang.php?page=1">First</a></li>
                            <li><a href="bukulist-pengarang?page=<?php echo $link_prev; ?>">&laquo;</a></li>
                            <?php
                                }
                            ?>
                            ...
                            <?php
                                ...
                                ?>
                                <li <?php echo $link_active; ?>><a href="bukulist-pengarang.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                            <?php
                                }
                            ?>
                            ...
                            ?>
                            <li><a href="bukulist-pengarang.php?page=<?php echo $link_next; ?>">&raquo;</a></li>
                            <li><a href="bukulist-pengarang.php?page=<?php echo $jumlah_page; ?>">Last</a></li>
                            <?php
                                }
                            ?>
                         </ul>
                ...
                <!-- /.col-lg-12 -->
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <?php  
                                    echo "<a class='btn btn-primary' data-toggle='tooltip' data-placement='left' title='Cetak' href='cetakbukupengarang.php?id=".$pengarang."' target='_blank'><i class='fa fa-print fa-fw'></i>Cetak Buku Berdasarkan Pengarang</a>";
                                ?>
                            </div>
