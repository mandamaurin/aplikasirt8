...
<body>
    <h1>Laporan Peminjaman Harian Buku SMP N 223</h1>
    <h2>Tanggal : <?php echo tanggal_indo(date('Y-m-d')); ?></h2>
            
    <table style="width: 100%">
        <?php

            
            $sql = "SELECT * FROM peminjaman, anggota, buku WHERE peminjaman.id_buku = buku.id_buku AND peminjaman.nomor_induk=anggota.nomor_induk AND peminjaman.tgl_pinjam = '$tanggal_sekarang'";
