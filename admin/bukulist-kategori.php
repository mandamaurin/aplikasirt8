            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            ?>
                            <li><a href="bukulist-kategori.php?page=1">First</a></li>
                            <li><a href="bukulist-kategori?page=<?php echo $link_prev; ?>">&laquo;</a></li>
                            <?php
                                }
                            ?>
                            ...
                            <?php
                                ...
                                ?>
                                <li <?php echo $link_active; ?>><a href="bukulist-kategori.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                            <?php
                                }
                            ?>
                            ...
                            ?>
                            <li><a href="bukulist-kategori.php?page=<?php echo $link_next; ?>">&raquo;</a></li>
                            <li><a href="bukulist-kategori.php?page=<?php echo $jumlah_page; ?>">Last</a></li>
                            <?php
                                }
                            ?>
                         </ul>
                ...
                <!-- /.col-lg-12 -->
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <?php  
                                    echo "<a class='btn btn-primary' data-toggle='tooltip' data-placement='left' title='Cetak' href='cetakbukukategori.php?id=".$idkategori."' target='_blank'><i class='fa fa-print fa-fw'></i>Cetak Buku Berdasarkan Kategori</a>";
                                ?>
                            </div>
