<?php
    ...
    if( $nama_file = $_FILES['foto']['name'] ){
      ...
      $query ="INSERT INTO buku(kode, foto, isbn, judul, pengarang, penerbit, tahun, stok, id_kategori, id_klasifikasi, nomor_klasifikasi ,klasifikasi) VALUE ('$kdbuku', 'Belum Ada' ,'$isbn' ,'$judul', '$pengarang', '$penerbit', '$tahun', '$stok', '$kategori', '$id_klasifikasi','$klasifikasi','$nama_klasifikasi')";
