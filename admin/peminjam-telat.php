...
?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Data Peminjam Telat</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                             <div class="box-tools" style="width: 350px; margin-left: 35px; margin-bottom: 20px;">
                                <form action="peminjam-telat.php" method="GET">
                                    <div class="input-group">
                                    <input type='text' class="form-control input-sm pull-right" name='qcari' placeholder='Cari Berdasarkan Nama' required /> 
                ...
                <div class="col-lg-12">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    <?php
                                        ...
                                        if(isset($_GET['qcari'])){
                                            $qcari = $_GET['qcari'];
                                            $sql = "SELECT * FROM peminjaman, anggota, buku, klasifikasi WHERE peminjaman.id_buku = buku.id_buku AND peminjaman.nomor_induk=anggota.nomor_induk AND buku.id_klasifikasi = klasifikasi.id AND peminjaman.batas_pinjam < '$tanggal_sekarang' AND anggota.nama_siswa like '%$qcari%' LIMIT ".$limit_start.",".$limit;
                                        } else{
                                            $sql = "SELECT * FROM peminjaman, anggota, buku, klasifikasi WHERE peminjaman.id_buku = buku.id_buku AND peminjaman.nomor_induk=anggota.nomor_induk AND buku.id_klasifikasi = klasifikasi.id  AND peminjaman.batas_pinjam < '$tanggal_sekarang' LIMIT ".$limit_start.",".$limit ;
                                        }
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            ?>
                            <li><a href="peminjaman-telat.php?page=1">First</a></li>
                            <li><a href="peminjaman-telat?page=<?php echo $link_prev; ?>">&laquo;</a></li>
                            <?php
                                }
                            ?>
                            ...
                            <?php
                                ...
                                ?>
                                <li <?php echo $link_active; ?>><a href="peminjaman-telat.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                            <?php
                                }
                            ?>
                            ...
                            ?>
                            <li><a href="peminjaman-telat.php?page=<?php echo $link_next; ?>">&raquo;</a></li>
                            <li><a href="peminjaman-telat.php?page=<?php echo $jumlah_page; ?>">Last</a></li>
                            <?php
                                }
                            ?>
                         </ul>
                    ...
                    <p>Jumlah Peminjam Telat: <?php echo mysqli_num_rows($query);  ?></p>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <a href="cetaklaporanpinjamtelat.php" target="_blank"><button class="btn btn-primary"><i class="fa fa-print fa-fw"></i>Cetak Semua Peminjam Telat</button></a>
                </div>
