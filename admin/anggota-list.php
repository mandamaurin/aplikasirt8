                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    <?php
                                        ...
                                        while ($anggota = mysqli_fetch_array($query)){
                                            ...
                                            echo "<td>";
                                            echo "<a class='btn btn-warning' data-toggle='tooltip' data-placement='left' title='Edit' href='anggota-formedit.php?id=".$anggota['id_anggota']."'><i class='fa fa-edit fa-fw'></i></a> <a class='btn btn-danger' data-toggle='tooltip' data-placement='left' title='Edit' href='anggota-hapus.php?id=".$anggota['id_anggota']."' onClick ='return hapus()'><i class='fa fa-trash fa-fw'></i></a> ";
                                            echo "</td>";
                                            echo "</tr>";
                                            echo "</tbody>";
