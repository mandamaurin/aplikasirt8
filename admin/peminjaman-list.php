                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    <?php
                                        ...
                                        if(isset($_GET['qcari'])){
                                            $qcari = $_GET['qcari'];
                                            $sql = "SELECT * FROM peminjaman, anggota, buku, klasifikasi WHERE peminjaman.id_buku = buku.id_buku AND peminjaman.nomor_induk=anggota.nomor_induk AND buku.id_klasifikasi = klasifikasi.id AND anggota.nomor_induk like '%$qcari%' LIMIT ".$limit_start.",".$limit;
                                        } else{
