      ...
      // Jika tipe file yang diupload JPG / JPEG / PNG, lakukan :
        ...
        // Proses upload
          if(move_uploaded_file($tmp_file, $path)){ // Cek apakah gambar berhasil diupload atau tidak
              ...
              $query = "UPDATE buku SET kode='$kdbuku',foto='$nama_file' ,judul='$judul', pengarang='$pengarang', penerbit='$penerbit', tahun='$tahun', stok='$stok', id_kategori='$kategori', id_klasifikasi = '$id_klasifikasi',nomor_klasifikasi = '$klasifikasi' ,klasifikasi ='$nama_klasifikasi' WHERE id_buku = '$id'";
              $sql = mysqli_query($koneksi, $query); // Eksekusi/ Jalankan query dari variabel $query
                ...
                // Jika Gagal, Lakukan :
                  header('Location: buku-formedit.php');
                }
       ...
       $query = "UPDATE buku SET kode='$kdbuku',foto='Belum Ada' ,judul='$judul', pengarang='$pengarang', penerbit='$penerbit', tahun='$tahun', stok='$stok', id_kategori='$kategori', id_klasifikasi = '$id_klasifikasi',nomor_klasifikasi = '$klasifikasi' ,klasifikasi ='$nama_klasifikasi' WHERE id_buku = '$id'";
              $sql = mysqli_query($koneksi, $query); // Eksekusi/ Jalankan query dari variabel $query
