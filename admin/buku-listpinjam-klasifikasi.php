                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                             <div class="box-tools" style="width: 350px; margin-left: 35px; margin-bottom: 20px;">
                                <form action="buku-listpinjam-klasifikasi.php" method="GET">
                ...
                <div class="col-lg-12">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    <?php
                                        ...
                                        if(isset($_GET['qcari'])){
                                            $qcari = $_GET['qcari'];
                                            $sql1 = "SELECT * FROM buku WHERE judul like '%$qcari%' or pengarang like '%$qcari%' or tahun like '%$qcari%' AND id_klasifikasi = '$id' LIMIT ".$limit_start.",".$limit;
                                        } else{
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            ?>
                            <li><a href="buku-listpinjam-klasifikasi.php?page=1">First</a></li>
                            <li><a href="buku-listpinjam-klasifikasi?page=<?php echo $link_prev; ?>">&laquo;</a></li>
                            <?php
                                }
                            ?>
                            ...
                            <?php
                                ...
                                ?>
                                <li <?php echo $link_active; ?>><a href="buku-listpinjam-klasifikasi.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                            <?php
                                }
                            ?>
                            ...
                            ?>
                            <li><a href="buku-listpinjam-klasifikasi.php?page=<?php echo $link_next; ?>">&raquo;</a></li>
                            <li><a href="buku-listpinjam-klasifikasi.php?page=<?php echo $jumlah_page; ?>">Last</a></li>
                            <?php
                                }
                            ?>
                         </ul>
